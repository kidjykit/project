...
class Segment
{
    ...
    function __construct() {
      ...
      //  print_r($this->_dictionary_array);
        ...
        while (!feof($file_stopword)) {
            $line_of_stopword = fgets($file_stopword);
            $this->_stopword_array[crc32(trim($line_of_stopword))] = trim($line_of_stopword);
        }
        fclose($file_stopword);
    ...
    public function get_segment_array($input_string) {
        ...
        //สร้าง Object array ใหม่ ให้แต่ละ File
